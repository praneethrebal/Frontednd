          ...
          const urls = await Promise.all(
            data.imagePaths.map(async (path) => {
              try {
                ...
                const imgRes = await BaseUrl.get(`/lottery/image/${filename}`, {
                  headers: { Authorization: `Bearer ${token}` },
                  responseType: "blob",
                });
            ...
            <div className="lottery-details-card">
              ...
              <div className="details-body">
                ...
                <div className="note-section mt-3">
                  <h5>📝 Note:</h5>
                  <p>
                    Please ensure your details are correct before purchasing the
                    ticket. Once bought, tickets are non-refundable.
                  </p>
                </div>
              </div>
            </div>
